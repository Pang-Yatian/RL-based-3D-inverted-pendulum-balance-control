...
class Agent:
    def __init__(self, train, learning_rate=0.0001, env=None, gamma=0.9, buffer_size=1000000, batch_size=512,
    ...
    def learn(self):
        ...
        q_values = self.eval_model.call(batch_next_state)
        y_batch = batch_reward + (self.gamma * tf.reduce_max(q_values, axis=1)) * (1 - batch_done)
