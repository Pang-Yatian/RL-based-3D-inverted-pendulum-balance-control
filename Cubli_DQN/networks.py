...
class EvalNetwork(tf.keras.Model):
    def __init__(self, name='eval_net', checkpoint_dir='model/dqn'):
        super().__init__()
        self.model_name = name
        self.checkpoint_dir = checkpoint_dir
        self.checkpoint_file = os.path.join(self.checkpoint_dir, self.model_name + '_dqn')
...
class TargetNetwork(tf.keras.Model):
    def __init__(self, name='target_net', checkpoint_dir='model/dqn'):
        super().__init__()
        self.model_name = name
        self.checkpoint_dir = checkpoint_dir
        self.checkpoint_file = os.path.join(self.checkpoint_dir, self.model_name + '_dqn')
